      ...
      <main className="w-full">
        ...
        >
          ...
          <p className="text-2xl font-light uppercase tracking-widest text-center max-w-2xl text-[#1a1a1a] z-10 px-8">
            Dedicated to crafting architecture that blends creativity, sustainability, and purpose, designing spaces that connect people, nature, and the built environment.
            Each project is approached with a vision to create meaningful, functional, and timeless spaces. Driven by the belief that thoughtful design has the power to shape experiences, inspire communities, and build a more sustainable future.
          </p>
        </section>
        ...
        <section className="h-[50vh] w-full flex flex-col items-center justify-center bg-[#1a1a1a] text-[#f4f4f4]">
          ...
          <div className="flex gap-8 mb-12">
            ...
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/in/yash-yadav-301841324" target="_blank" rel="noopener noreferrer" className="text-[#f4f4f4] hover:text-gray-400 transition-colors hover:-translate-y-1 transform duration-300">
            ...
            {/* GitHub */}
            <a href="https://github.com/yashyadavar" target="_blank" rel="noopener noreferrer" className="text-[#f4f4f4] hover:text-gray-400 transition-colors hover:-translate-y-1 transform duration-300">
              <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/specific.architecture?igsh=MWJnYTB5aWNwb3Jm" target="_blank" rel="noopener noreferrer" className="text-[#f4f4f4] hover:text-gray-400 transition-colors hover:-translate-y-1 transform duration-300">
              <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            {/* Email */}
            <a href="yashydv02@yahoo.com" className="text-[#f4f4f4] hover:text-gray-400 transition-colors hover:-translate-y-1 transform duration-300">
